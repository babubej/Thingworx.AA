...
if (utilisationFilter !== undefined && utilisationFilter !== null && utilisationFilter.trim() !== '' && utilisationFilter !== 'ALL') {
	if (utilisationFilter === 'LT50VARCOMPUTIL') {
		utilisationFilterName = 'VarCompUtil_Less_than_50_per';
	} else if (utilisationFilter === 'GT50VARCOMPUTIL') {
		utilisationFilterName = 'VarCompUtil_Greater_than_50_per';
	}
...
var params = {
	...
	dataShapeName: "ELGi.COMP.VarSpeedCompressors.DS"
};
...
for (var x = 0; x < tableLength; x++) {
	...
	if (row.VarCompUtil_Less_than_50_per === true) {
		newEntry.description = 'LESS THAN 50% UTIL.';
	} else if (row.VarCompUtil_Greater_than_50_per === true) {
		newEntry.description = 'GREATER THAN 50% UTIL.';
	} else {
