...
if (distinctList !== undefined && distinctList !== null && distinctList.rows.length > 0) {
	...
	for (var x = 0; x < tableLength; x++) {
		...
		if ( customer !== undefined && customer !== 'undefined' && customer !== null && customer.trim() !== '') {
			newEntry = new Object();			
	...
	logger.error("Error occured in ELGi.COMP.MashupHelper.Thing : GetCustomersList. Error : " + err);
}    
