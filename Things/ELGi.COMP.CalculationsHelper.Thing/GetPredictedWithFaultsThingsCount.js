...
logger.info("GetPredictedWithFaultsThingsCount START");
try {
	...
	// Query Logic - Query all the things where Predicted Alerts are available
	var query2 = {
		"filters": {
			"type": "GT",
...
logger.info("GetPredictedWithFaultsThingsCount END");
