logger.info("GetVarSpeedUtilThingsCount START");
...
try {
	...
	// Query Logic - Query all the Commisioned VFD things
	...
	// Query Logic - Query all things where VarCompUtil_Less_than_50_per is true
	var query2 = {
		"filters": {
			"type": "EQ",
			"fieldName": "VarCompUtil_Less_than_50_per",
			"value": true
		}
	};
...
logger.info("GetVarSpeedUtilThingsCount END");
