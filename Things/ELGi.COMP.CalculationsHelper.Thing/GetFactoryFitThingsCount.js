logger.info("GetFactoryFitThingsCount START");
...
logger.debug("Before REgion Filter : "+region);    
if (region !== undefined && region !== null && region.trim() !== '' && region !== 'All' ) {
	...
	queryObjects.push(filter);
    logger.debug("INSIDE REgion Filter : "+region);
}
...
logger.info("GetFactoryFitThingsCount END");
